...
namespace RSG
{
    ...
    /// </summary>
    public interface IPromise<PromisedT> : IBasePromise
    {
        /// <summary>
...
//            Argument.NotNull(() => onRejected);
        ...
        /// Add a resolved callback that chains a value promise (optionally converting to a different value type).
        /// </summary>
        /// ADDED: Base class added for all types of promises
        public IBasePromise BaseThen<ConvertedT>(Func<IPromise<ConvertedT>> onResolved)
        {
            return BaseThen(onResolved, null, null);
        }
        ...
        /// </summary>
        /// ADDED: Base class added for all types of promises
        public IBasePromise BaseThen(Func<IPromise> onResolved)
        {
            return BaseThen(onResolved, null, null);
        }
        ...
        /// </summary>
        /// ADDED: Base class added for all types of promises
        public IBasePromise BaseThen(Action onResolved)
        {
            return BaseThen(onResolved, null, null);
        }
        ...
        /// </summary>
        /// ADDED: Base class added for all types of promises
        public IBasePromise BaseThen<ConvertedT>(
            Func<IPromise<ConvertedT>> onResolved,
            Action<Exception> onRejected)
        {
            return BaseThen(onResolved, onRejected, null);
        }
        ...
        /// </summary>
        /// ADDED: Base class added for all types of promises
        public IBasePromise BaseThen(
            Func<IPromise> onResolved,
            Action<Exception> onRejected)
        {
            return BaseThen(onResolved, onRejected, null);
        }
...
//            Argument.NotNull(() => onResolved); 
        ...
        public IPromise Then(
            Func<PromisedT, IPromise> onResolved, 
            Action<Exception> onRejected,
            Action<float> onProgress)
        {
        ...
        /// </summary>
        /// ADDED: Progress ripped from 3.0
        public IPromise<PromisedT> Then(
            Action<PromisedT> onResolved,
            Action<Exception> onRejected,
            Action<float> onProgress)
        {
            var resultPromise = new Promise<PromisedT>();
